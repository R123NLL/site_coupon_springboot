...
//        companyRepository.saveAll(Arrays.asList(Mapper.mapToCompany(
//                        new NewCompanyRequest("Coleman", "office@Coleman.com", "12345", null))
//                , Mapper.mapToCompany(new NewCompanyRequest("ViewSonic", "office@Viewsonic.com", "123123", null))
//                , Mapper.mapToCompany(new NewCompanyRequest("Logitech", "office@Logitech.com", "54321", null))
//                , Mapper.mapToCompany(new NewCompanyRequest("Oxford", "office@Oxford.com", "122333", null))
//                , Mapper.mapToCompany(new NewCompanyRequest("Jbl", "office@Jbl.com", "132213", null))));
